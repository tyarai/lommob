//
//  WatchingSitesDetailTableViewController.m
//  LOM
//
...
@interface WatchingSitesDetailTableViewController ()

@end

@implementation WatchingSitesDetailTableViewController
...
- (void)viewDidLoad {
    ...
    if(self.lemursWatchingSites) {
        self.siteTitle.text = self.lemursWatchingSites._title;
        self.details.text = self.lemursWatchingSites._body;
    }
}
