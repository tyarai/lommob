//
//  SpeciesDetailInfoTableViewController.m
//  LOM
//
...
@interface SpeciesDetailInfoTableViewController ()

@end

@implementation SpeciesDetailInfoTableViewController
...
- (void)viewDidLoad {
    ...
    if(self.specy){
        ...
        self.details.text         = self.stringDetails;
