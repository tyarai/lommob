 ...
 * Created by saimon
 */
public class WatchingSiteAdapter extends RecyclerView.Adapter<WatchingSiteAdapter.ViewHolder> {

    private static final String TAG = WatchingSiteAdapter.class.getSimpleName();

    private List<WatchingSite> listItems, filterList;
    private Context context;

    public WatchingSiteAdapter(Context applicationContext, List<WatchingSite> WatchingSiteArrayList) {
